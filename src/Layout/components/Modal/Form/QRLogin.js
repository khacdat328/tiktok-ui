...
import QR_intruction from '~/assets/images/QR_intruction.gif';
...
function QRLogin() {
   return (
      <>
         <h1 className={cx('title')}>Log in with QR code</h1>
         <div className={cx('QR-content')}>
            <div className={cx('QR-code')}>
               <img src={QR_code} alt="qrcode.png"/>
            ...
            <img src={QR_intruction} alt="" className={cx('phone-image')} />
         </div>
      </>
   );
}
